...
file_name = "plasma_donor_survey.csv"
seed = None#1
learning_rate = 0.1
max_depth = 10
estimators = 1000
...
clf = GradientBoostingClassifier(n_estimators=estimators, learning_rate=learning_rate, max_depth=max_depth, random_state=seed)
